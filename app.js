...
function validaEmail(){
    const regex = /^[a-zA-Z0-9_]+[@][a-zA-Z0-9_]+\.[a-zA-Z0-9_]+$/; // ou /\w+@\w\.\w+/ (representa qualquer caractere) \d representa números \s espaços em brancos
...
function validaSenha(){
    const regex = /^(?=.*[A-Z])(?=.*[a-z])(?=.*[0-9])(?=.*[!@#$%&*-_]).{6,15}$/;
